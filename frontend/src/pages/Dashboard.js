  ...
  return(
    <div style={PAGE}>
      ...
      <div style={{padding:'16px',maxWidth:600,margin:'0 auto',width:'100%'}}>
        ...
        <button onClick={()=>window.location.assign('https://mechatech.io/#pricing')} style={{background:'#E8232A',color:'#fff',padding:'6px 12px',borderRadius:3,fontSize:10,fontWeight:700,letterSpacing:1.5,textTransform:'uppercase',cursor:'pointer',border:'none'}}>UPGRADE</button>
