  ...
  return(
    <div style={PAGE}>
      ...
      <div style={{padding:'16px',maxWidth:600,margin:'0 auto',width:'100%'}}>
        ...
        {selVeh&&!adding&&<><Btn onClick={()=>window.location.href='/#pricing'} style={{fontSize:11,letterSpacing:1.5,gridColumn:'span 2',background:'linear-gradient(135deg,#E8232A,#ff6b35)',border:'none'}}>⭐ Upgrade to Pro — $9.99/mo</Btn><Btn onClick={()=>navigate('/diagnose')} style={{marginTop:10}}>Diagnose {selVeh.nickname||selVeh.model}</Btn></> }
