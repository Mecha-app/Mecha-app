  ...
  return(
    <div style={PAGE}>
      ...
      <div style={{padding:'16px',maxWidth:600,margin:'0 auto',width:'100%'}}>
        ...
        <div onClick={()=>{window.location.href='https://mechaapp.vercel.app/#pricing';}} style={{background:'#E8232A',color:'#fff',padding:'6px 12px',borderRadius:3,fontSize:10,fontWeight:700,letterSpacing:1.5,textTransform:'uppercase',cursor:'pointer'}} onClick={()=>{window.location.href='https://mechatech.io/#pricing';}}>Upgrade</div>
