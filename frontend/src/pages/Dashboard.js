  ...
  return(
    <div style={PAGE}>
      ...
      <div style={{padding:'16px',maxWidth:600,margin:'0 auto',width:'100%'}}>
        ...
        <div onClick={()=>{navigate('/');setTimeout(()=>document.getElementById('pricing')?.scrollIntoView({behavior:'smooth'}),500);}} style={{background:'#E8232A',color:'#fff',padding:'6px 12px',borderRadius:3,fontSize:10,fontWeight:700,letterSpacing:1.5,textTransform:'uppercase',cursor:'pointer'}}>Upgrade</div>
